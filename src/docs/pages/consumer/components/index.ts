/**
 * Consumer Experience Components
 * 
 * Reusable components specific to the consumer experience pages.
 */
...
export { FloatLabelSelect, type FloatLabelSelectProps } from "./FloatLabelSelect";
