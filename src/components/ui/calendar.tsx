    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "[&>svg]:text-wex-calendar-day-outside-fg flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-sm [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-wex-calendar-day-outside-fg flex-1 select-none rounded-md text-[0.8rem] font-normal",
        ...
        range_end: cn("bg-wex-calendar-day-range-bg rounded-r-md", defaultClassNames.range_end),
        today: cn(
